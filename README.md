...
```
wget https://raw.githubusercontent.com/ScriptElite/PhyrePanel/main/installers/install.sh && chmod +x install.sh && ./install.sh
```
...
```
rm -rf update.sh && wget https://raw.githubusercontent.com/ScriptElite/PhyrePanel/main/web/update.sh && chmod +x update.sh && ./update.sh
```
